...
return array(
    ...
    'configform' => array(
        ...
        array(
            'type'      => 'freearea',
            'container' => false,
            'value'     => '<div class="ds__form-head">Заказать услугу</div>'
        ),
        ...
        array(
            ...
            'container' => true,
            'formail'   => 1,
            'name_mail' => 'Вид фундамента',
            'attributs' => array(
                'name'  => 'Услуга',
                'class' => 'popup_custom-select'
            ),
            'options' => array(
                array('text'=> 'Услуга', 'value' => 'ростверк на буронабивных сваях', 'selected'=> ''),
                array('text'=> 'Услуга2', 'value' => 'винтовые сваи'),
                array('text'=> 'Услуга3', 'value' => 'плита'),
        ...
        array(
            'type'      => 'freearea',
            'container' => false,
            'value'     => '<script src="../../../libs/formStyler/jquery.formstyler.min.js"></script><script>$(".popup_custom-select").styler();</script>
