...
class DSFormSend extends DSMain {
	...
	public function index() {
		...
		if(@$this->mail->send()){
			if (file_exists(DS_FORM_ROOT . '/template/custom/' . $this->formID . '/do.php')){
				require_once(DS_FORM_ROOT . '/template/custom/' . $this->formID . '/do.php');
			}
			$this->responseJson(
					array(
						'error'      => 0,
