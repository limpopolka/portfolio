<?php
  $selectType = (isset($attributs['type']))? $attributs['type'] : 'text';
        ...
        <form id="field-attributs" role="form">
          ...
          <div class="form-group">
            ...
            <?php foreach($arrType as $type):?>
              <option <?php if($selectType == $type) echo 'selected'?>><?php echo $type;?></option>
            <?php endforeach;?>
            </select>
          </div>
          <?php
            ...
            if(isset($attributs['type']))unset($attributs['type']);
          ?>
